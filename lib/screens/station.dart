...
class _MyStationState extends State<MyStation> {
  ...
  LatLng currentLocation = const LatLng(28.656473, 77.242943);
                ...
                child: Column(children: [
                  TabBar(
                      ...
                      tabs: [
                        ...
                        Tab(
                            text: "Storage",
                            icon: Image.asset('assets/images/storage.png',
                                height: 30)),
                        Tab(
                            text: "Manpower",
                            icon: Image.asset('assets/images/manpower.png',
                                height: 30)),
                        Tab(
                            text: "Soil Test",
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  onPressed: () async {
                    try {
                      final query = mySearchController.text;
                      var addresses =
                          await Geocoder.local.findAddressesFromQuery(query);
                      var first = addresses.first;
                      LatLng newPosition = LatLng(first.coordinates.latitude!,
                          first.coordinates.longitude!);
                      myMapController.animateCamera(
                          CameraUpdate.newCameraPosition(
                              CameraPosition(target: newPosition, zoom: 12)));
                      addMarker("search", newPosition);
                      mySearchController.clear();
                    } on Exception catch (e) {
                      mySearchController.text = "No such place exists";
